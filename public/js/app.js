import { loginAdmin, fetchComplaints, createComplaint, updateComplaint, deleteComplaintAPI } from './api.js';
...
window.changePublicImage = changePublicImage;
window.closeSuccessModal = closeSuccessModal;
window.closeAssignModal = closeAssignModal;
window.confirmAssignment = confirmAssignment;
window.closeCompletionModal = closeCompletionModal;
window.changeCompletionImage = changeCompletionImage;
window.submitCompletion = submitCompletion;
window.closeViewModal = closeViewModal;
window.closeDeleteModal = closeDeleteModal;
window.confirmDelete = confirmDelete;
window.exportComplaintsToCSV = exportComplaintsToCSV;
